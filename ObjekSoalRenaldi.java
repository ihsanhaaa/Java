 ...
 * ObjekSoalRenaldi
 */
public class ObjekSoalRenaldi {

    int saldoAwal, profitPersen, profit, saldoAkhir;

    public ObjekSoalRenaldi(int saldoAwal, int profitPersen, int profit, int saldoAkhir) {
    ...
    /**
     * @param profitPersen the profitPersen to set
     */
