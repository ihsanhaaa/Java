...
public class Mid2019Soal2 {
    ...
    public static void main(String[] args) {
        ...
        List<Forex> forex = new ArrayList<Forex>();
        long saldoAwal = 0;
        ...
        //------------------------------------------    
            ...
            try {
                do{
                    ...
                    if (!validasiInput(sPersenProfit) || 
                        !validasiInputMax(persenProfitMin, sPersenProfit)){
                        System.out.println("\t***Invalid Number***");
                    }
            ...
            System.out.println("------------------------------------------------------------------------");
            System.out.printf("|%10s| %13s| %13s| %13s| %13s|","Bulan Ke-", "Saldo Awal", "%Profit", "Profit","Saldo Akhir");
            System.out.println();
            System.out.println("------------------------------------------------------------------------");
            for (int i = 0;i < forex.size();i++){
                System.out.format("|%10d| %,13d| %,13d| %,13d| %,13d|",
                 i+1,
                 forex.get(i).getDanaAwal(),
                 forex.get(i).getPersenProfit(),
                 forex.get(i).getNominalProfit(),
                 forex.get(i).getDanaAkhir()
                );
                System.out.println();
            }
            System.out.println("------------------------------------------------------------------------");
